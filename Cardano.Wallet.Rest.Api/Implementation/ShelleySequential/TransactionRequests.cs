...
{
	internal class TransactionRequests : ITransactionRequests
	{
		...
		public TransactionRequests(IGetRequests getRequests,
			...
			OrderEnum order = null)
		{
			...
			var result = await getRequests.GetAsync<IEnumerable<Transaction>>(pathBase);
