...
{
    public interface IMigrationRequests
    {
        /// <summary>
        ...
        /// A typical usage would be when one wants to move all funds from an old wallet to another by providing addresses coming from the new wallet.
		/// </summary>
        /// <returns>
        /// 200 Ok,
        /// 403 Forbidden,
        ...
        /// </returns>
        Task<Response<IEnumerable<Transaction>>> MigrateAsync(string walletId, MigrationData migrationData);
        ...
        /// 406 Not Acceptable
        /// </returns>
        Task<Response<MigrationFullCost>> GetCostAsync(string walletId);
    }
}
